      ...
      children: [
        Container(
          ...
          child: DropdownButtonFormField<T>(
            ...
            icon: Icon(Icons.arrow_drop_down, size: 24, color: Colors.grey[400]),
            ...
            decoration: InputDecoration(
              ...
              contentPadding: const EdgeInsets.only(top: 12, bottom: 12, right: 16, left: 10),
              enabledBorder: const OutlineInputBorder(borderRadius: BorderRadius.only(
                  bottomLeft: Radius.circular(17),
                  topLeft: Radius.circular(17),
                  bottomRight: Radius.circular(17)
              ),borderSide: BorderSide(color: Colors.transparent,width: 1.3)),
              focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10.0),borderSide: const BorderSide(color: Colors.transparent,width: 1.3)),
